...
import { lstatSync, Mode, readFileSync, writeFileSync } from 'node:fs';
...
describe('tree', () => {
  describe('FsTree', () => {
    ...
    it('should log error when read and write files error occurs', () => {
      expect(tree.read('error.txt')).toBeUndefined();
    ...
    it('should overwrite files', () => {
      ...
      expect(readFileSync(path.join(dir, 'root-file.txt'), 'utf8')).toEqual(
        'overwrite content',
      );
    });
    ...
    it('should be able to create files', () => {
      ...
      expect(tree.read('parent/new-parent-file.txt', 'utf8')).toEqual(
        'new parent content',
      );
      expect(
        tree
          .read('parent/new-parent-file-with-write-options.txt', 'utf8')
          ?.toString(),
      ).toEqual('new parent content with write options');
      expect(
        tree.read('parent/new-child/new-child-file.txt', 'utf8')?.toString(),
      ...
      expect(
        readFileSync(path.join(dir, 'parent/new-parent-file.txt'), 'utf8'),
    ...
    it('should normalize paths', () => {
      ...
      expect(tree.read('dir/file1', 'utf8')).toEqual('File 1 Contents');
      expect(tree.read('/dir/file1', 'utf8')).toEqual('File 1 Contents');
      expect(tree.read('./dir/file1', 'utf8')).toEqual('File 1 Contents');

      expect(tree.read('dir/file2', 'utf8')).toEqual('File 2 Contents');
      expect(tree.read('/dir/file2', 'utf8')).toEqual('File 2 Contents');
      expect(tree.read('./dir/file2', 'utf8')).toEqual('File 2 Contents');

      expect(tree.read('dir/file3', 'utf8')).toEqual('File 3 Contents');
      expect(tree.read('/dir/file3', 'utf8')).toEqual('File 3 Contents');
      expect(tree.read('./dir/file3', 'utf8')).toEqual('File 3 Contents');

      tree.rename('dir/file1', 'dir/file-a');

      expect(tree.read('dir/file-a', 'utf8')).toEqual('File 1 Contents');
      expect(tree.read('/dir/file-a', 'utf8')).toEqual('File 1 Contents');
      expect(tree.read('./dir/file-a', 'utf8')).toEqual('File 1 Contents');

      tree.rename('/dir/file2', '/dir/file-b');

      expect(tree.read('dir/file-b', 'utf8')).toEqual('File 2 Contents');
      expect(tree.read('/dir/file-b', 'utf8')).toEqual('File 2 Contents');
      expect(tree.read('./dir/file-b', 'utf8')).toEqual('File 2 Contents');

      tree.rename('./dir/file3', './dir/file-c');

      expect(tree.read('dir/file-c', 'utf8')).toEqual('File 3 Contents');
      expect(tree.read('/dir/file-c', 'utf8')).toEqual('File 3 Contents');
      expect(tree.read('./dir/file-c', 'utf8')).toEqual('File 3 Contents');
    });
    ...
    it('should be able to delete files', () => {
      ...
      expect(tree.read('parent/parent-file.txt')).toBeUndefined();
      expect(tree.read('parent/new-child/new-child-file.txt')).toBeUndefined();

      expect(s(tree.listChanges())).toEqual([
        { path: 'parent/parent-file.txt', type: 'DELETE' },
      ]);
    ...
    it('should be able to rename files', () => {
      ...
      expect(tree.read('parent/new-child/new-child-file.txt')).toBeUndefined();
      expect(tree.read('root-file.txt')).toBeUndefined();
      expect(tree.read('renamed-new-child-file.txt', 'utf8')).toEqual(
        'new child content',
      );
      expect(tree.read('renamed-root-file.txt', 'utf8')).toEqual(
        'root content',
      );
      ...
      expect(s(tree.listChanges())).toEqual([
        ...
        { path: 'root-file.txt', type: 'DELETE' },
      ]);

      flushChanges(dir, tree.listChanges());

      expect(
        readFileSync(path.join(dir, 'renamed-new-child-file.txt'), 'utf8'),
      ).toEqual('new child content');
      expect(
        readFileSync(path.join(dir, 'renamed-root-file.txt'), 'utf8'),

 ...
 */
function getDefs(chalk: chalk.Chalk) {
  return {
    gutter: chalk.grey,
...
function getMarkerLines(
  ...
  markerLines: Record<string | number, unknown>;
} {
  ...
  const markerLines: Record<string | number, unknown> = {};
    ...
    .map((line, index) => {
      ...
      if (hasMarker) {
        ...
        if (Array.isArray(hasMarker)) {
          ...
          markerLine = [
            '\n ',
            defs.gutter(gutter.replaceAll(/\d/g, ' ')),
            markerSpacing,

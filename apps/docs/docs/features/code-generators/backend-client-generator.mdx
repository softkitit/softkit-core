...
It has a dependency on ClsService for automatic user token and request id propagation for tracing and convenience.

Also it has a super convenient feature to proxy errors from your microservice to the client application.

...
- **Ready to use customizable [microservices](/what-is-microservice), with general business logic**  *(e.g. Invoice Generation, Payment Processing, Files Management, etc...)*

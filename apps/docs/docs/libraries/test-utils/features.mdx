...
- **imageName & imageTag**: Selects the Postgres Docker image. By default, it uses `'postgres:15.4-alpine'`; override both values to use a compatible image such as pgvector.

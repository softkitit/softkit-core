...
describe('auth e2e test', () => {
  ...
  describe('approve signup', () => {
    ...
    it('approve registration with unknown id', async () => {
      const response = await app.inject({
        method: 'POST',
        url: 'api/platform/v1/auth/approve-signup',
        payload: {
          approvalId: faker.string.uuid(),
    ...
    it('approve registration with valid id, but invalid code', async () => {
      const signUpResponse = await app.inject({
        method: 'POST',
        url: 'api/platform/v1/auth/signup',
        payload: successSignupDto,
  ...
  describe('saml auth', () => {
    ...
    function mockSuccessSamlStrategyCall(userEmail = faker.internet.email()) {
      jest
        ...
        .mockImplementation(async (req, res, replyData) => {
          // @ts-ignore
          const strategy = await samlService.createStrategyByTenantUrl(
            req,
            res,
            replyData,
          );
    ...
    beforeEach(async () => {
      ...
      const firstUser = await userService.findOneByEmailWithRoles(
      ...
      tenantWithoutSamlConfiguration = await tenantService.findOneById(
        secondUser.tenantId,
      );
    ...
    it('should return a 401 error if there is no configuration for tenant', async () => {
      const samlLoginResponse = await app.inject({
        method: 'GET',
        url: `api/platform/v1/auth/sso/saml/login?tenantId=${tenantWithSamlConfiguration.id}&redirectUrl=${tenantWithSamlConfiguration.tenantUrl}`,
        headers: {
          host: `${tenantWithSamlConfiguration.tenantUrl}`,
        },
      });
    ...
    it('try saml auth for not configured tenant', async () => {
      const samlLoginResponse = await app.inject({
        method: 'GET',
        url: `api/platform/v1/auth/sso/saml/login?tenantId=${tenantWithoutSamlConfiguration.id}&redirectUrl=${tenantWithoutSamlConfiguration.tenantUrl}`,
        headers: {
          host: `${tenantWithoutSamlConfiguration.tenantUrl}`,
        },
      });
    ...
    it('get a valid metadata for saml', async () => {
      const samlMetadataResponse = await app.inject({
        method: 'GET',
        url: `api/platform/v1/auth/saml/sso/metadata`,
        headers: {
          host: `${tenantWithSamlConfiguration.tenantUrl}`,
        },
      });
    ...
    it('saml strategy success callback methods test', async () => {
      const samlLoginResponse = await app.inject({
        method: 'GET',
        url: `api/platform/v1/auth/sso/saml/login?tenantId=${tenantWithSamlConfiguration.id}&redirectUrl=${tenantWithSamlConfiguration.tenantUrl}`,
        headers: {
    ...
    it('saml sign in for main user that created a tenant', async () => {
      ...
      mockSuccessSamlStrategyCall(faker.internet.email());
    ...
    it('saml sign in with no email in a profile provided', async () => {
      const samlLoginResponse = await app.inject({
        method: 'GET',
        url: `api/platform/v1/auth/sso/saml/login?tenantId=${tenantWithSamlConfiguration.id}&redirectUrl=${tenantWithSamlConfiguration.tenantUrl}`,
        headers: {
    ...
    it('should return 401 if SAML RelayState is invalid', async () => {
      // multiple logins should behave the same way always
      mockSuccessSamlStrategyCall();
    ...
    it('saml strategy fail callback methods test', async () => {
      const samlLoginResponse = await app.inject({
        method: 'GET',
        url: `api/platform/v1/auth/sso/saml/login?tenantId=${tenantWithSamlConfiguration.id}&redirectUrl=${tenantWithSamlConfiguration.tenantUrl}`,
        headers: {
    ...
    it('saml strategy pass callback method test', async () => {
      const samlLoginResponse = await app.inject({
        method: 'GET',
        url: `api/platform/v1/auth/sso/saml/login?tenantId=${tenantWithSamlConfiguration.id}&redirectUrl=${tenantWithSamlConfiguration.tenantUrl}`,
        headers: {
